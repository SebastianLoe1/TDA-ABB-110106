...
void CrearAbb(){
	...
	pa2m_afirmar(arbol->comparador == comparador, "El comparador es valido.\n");
	abb_destruir(arbol);
}
...
void InsertarAbb(){
	...
	pa2m_afirmar(abb_insertar(NULL, &e1) == NULL, "No se puede insertar en un arbol NULL.");
	pa2m_afirmar(abb_insertar(arbol, &e1) == arbol, "Se puede insertar un elemento.");
	pa2m_afirmar(abb_tamanio(arbol) == 1, "Se actualiza correctamente el tamaño del arbol.\n");
	...
	pa2m_afirmar(abb_tamanio(arbol) == 7, "Se actualiza correctamente el tamaño del árbol con 7 elementos");

	nodo_abb_t *nodo_actual = arbol->nodo_raiz;
	pa2m_afirmar(nodo_actual->elemento == &e1, "El 1er elemento insertado esta en su posicion correcta.");
	pa2m_afirmar(nodo_actual->izquierda->elemento == &e2, "El 2do elemento insertado esta en su posicion correcta.");
	pa2m_afirmar(nodo_actual->derecha->elemento == &e5, "El 3er elemento insertado esta en su posicion correcta.");
	pa2m_afirmar(nodo_actual->izquierda->izquierda->elemento == &e3, "El 4to elemento insertado esta en su posicion correcta.");
	pa2m_afirmar(nodo_actual->izquierda->derecha->elemento == &e4, "El 5to elemento insertado esta en su posicion correcta.");
	pa2m_afirmar(nodo_actual->derecha->izquierda->elemento == &e6, "El 6to elemento insertado esta en su posicion correcta.");
	pa2m_afirmar(nodo_actual->derecha->derecha->elemento == &e7, "El 7mo elemento insertado esta en su posicion correcta.\n");
	pa2m_afirmar(abb_vacio(arbol) == false, "El árbol no se encuentra vacío con varios elementos.");
	abb_destruir(arbol);
}
...
void QuitadoMasivo(){
	int e1 = 10, e2 = 5, e3 = 2, e4 = 7, e5 = 15, e6 = 12,
	    e7 = 17;
	abb_t *arbol = abb_crear(comparador);
	abb_insertar(arbol, &e1);
	abb_insertar(arbol, &e2);
...
void ConCadaElementoAbb()
{
	abb_recorrido e1 = 10;
	abb_t *arbol = abb_crear(comparador);
	pa2m_afirmar(abb_con_cada_elemento(NULL, INORDEN, cuenta_todo,
					   NULL) == 0,
	...
	abb_insertar(arbol, &e1);
	pa2m_afirmar(abb_con_cada_elemento(arbol, INORDEN, cuenta_todo,
					   NULL) != 0,
...
void ConCadaPreorden()
{
	int e1 = 10, e2 = 5, e3 = 2, e4 = 7, e5 = 15, e6 = 12,
	    e7 = 17;
	pa2m_afirmar(abb_con_cada_elemento(NULL, PREORDEN, cuenta_todo,
					   &e1) == 0,
	...
	pa2m_afirmar(abb_con_cada_elemento(arbol, PREORDEN, cuenta_todo,
					   &e1) == 0,
	...
	abb_insertar(arbol, &e7);
	pa2m_afirmar(
		abb_con_cada_elemento(arbol, PREORDEN, cuenta_todo, NULL) ==
			7,
...
void ConCadaPostorden()
{
	int e1 = 10, e2 = 5, e3 = 2, e4 = 7, e5 = 15, e6 = 12,
	    e7 = 17;
	pa2m_afirmar(abb_con_cada_elemento(NULL, POSTORDEN, cuenta_todo,
					   &e1) == 0,
	...
	abb_insertar(arbol, &e7);
	pa2m_afirmar(
		abb_con_cada_elemento(arbol, POSTORDEN, cuenta_todo, NULL) ==
			7,
